...
echo 'alias morley="$HOME/core-bridgechain/packages/core/bin/run"' >> ~/.bashrc

rm -rf "$HOME/core-bridgechain"
git clone "https://github.com/xianfeic/morley" "$HOME/core-bridgechain" || FAILED="Y"
if [ "$FAILED" == "Y" ]; then
    echo "Failed to fetch core repo with origin 'https://github.com/xianfeic/morley'"
...
rm -rf "$HOME/.config/@morley"
rm -rf "$HOME/.config/@morley"
rm -rf "$HOME/.config/morley-core"
